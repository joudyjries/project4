                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$type->name}}</td>
                                                <td><img src="{{asset($type->image)}}" style="width:70px;" alt=""></td>
                                                <td> <button type="button" class="btn btn-info" data-bs-toggle="modal" data-original-title="test" data-bs-target="#exampleModalEdit{{$type->id}}">
                                                        تعديل صنف
                                                    </button>
                                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-original-title="test" data-bs-target="#exampleModalDelete{{$type->id}}">
                                                        حذف صنف
                                                    </button>
                                                </td>
                                            </tr>
                                            ...
                                            <!-- modal edit -->
                                            <div class="modal fade" id="exampleModalEdit{{$type->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    ...
                                                    <form action="{{route('type.update' , $type->id)}}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <input type="text" name="name" class="form-control" value="{{$type->name}}" id="recipient-name">
                                                            </div>
                                                            <div class="modal-body">
                                            ...
                                            <!-- modal delete -->
                                            <div class="modal fade" id="exampleModalDelete{{$type->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <form action="{{route('type.destroy' , $type->id)}}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('DELETE')
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <div class="modal-body">
                                                                <label for="recipient-name" class="col-form-label">{{$type -> name}} هل انت متأكد من حذف الصنف</label>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button class="btn btn-primary" type="button" data-bs-dismiss="modal">Close</button>
                                                                <button class="btn btn-secondary" type="submit">Save changes</button>
