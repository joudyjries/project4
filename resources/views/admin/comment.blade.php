                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$comment->content->name}}</td>
                                                <td>{{$comment->comment}}</td>
                                                <td>
                                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-original-title="test" data-bs-target="#exampleModalDelete{{$comment->id}}">
                                                        حذف التعليق
                                                    </button>
                                                </td>
                                            </tr>
                                            ...
                                            <!-- modal delete -->
                                            <div class="modal fade" id="exampleModalDelete{{$comment->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    ...
                                                    <form action="{{route('deleteComment' , $comment->id)}}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <label for="recipient-name" class="col-form-label">{{$comment -> name}} هل انت متأكد من حذف التعليق</label>
                                                            </div>
